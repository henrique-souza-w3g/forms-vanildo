...
export default function Beneficiario({ children, setInputsBeneficiario }: BeneficiarioProps) {
    ...
    return (
        <div id="beneficiario">
        <p className="title beneficiario text-center text-2xl font-bold p-2">{children}</p>
        <form className="forms beneficiario grid grid-cols-3 gap-3 p-4">
            <div className="grid w-[70%] h-20">
                <label className="font-bold mr-2">NOME</label>
                <input className="border rounded-md w-auto" type="text" value={nome} onChange={(e) => setNome(e.target.value)} />
            </div>
            <div className="grid w-[70%] h-20">
                <label className="font-bold mr-2">CPF</label>
                <input className="border rounded-md w-auto" type="text" value={cpf} onChange={(e) => setCPF(formatCPF(e.target.value))}/>
            </div>
            <div className="grid w-[70%] h-20">
                <label className="font-bold mr-2">RG</label>
                <input className="border rounded-md w-auto" type="text" value={rg} onChange={(e) => setRg(formatRG(e.target.value))}/>
            </div>
            <div className="grid w-[70%] h-20">
                <label className="font-bold mr-2">DATA NASCIMENTO</label>
                <input className="border rounded-md w-auto" type="date" value={dataNascimento} onChange={(e) => setDataNascimento(e.target.value)}/>
            </div>
            <div className="grid w-[70%] h-20">
            <label className="font-bold mr-2">ESTADO CIVIL</label>
            <select className="border rounded-md w-auto" value={estadoCivil} onChange={(e) => setEstadoCivil(e.target.value)}>
                <option value="0">Selecionar</option>
                <option value="Solteiro">Solteiro</option>
                <option value="Casado">Casado</option>
                <option value="Vivorciado">Divorciado</option>
                <option value="Viúvo">Viúvo</option>
            </select>
            </div>
            <div className="grid w-[70%] h-20">
                <label className="font-bold mr-2">Nº CARTÃO SUS</label>
                <input className="border rounded-md w-auto" type="text" value={sus} onChange={(e) => setSus(e.target.value)}/>
            </div>
            <div className="grid w-[70%] h-20">
                <label className="font-bold mr-2">DECLAR. NASCIDO VIVO</label>
                <input className="border rounded-md w-auto" type="text" value={declaracao} onChange={(e) => setDeclaracao(e.target.value)}/>
            </div>
            <div className="grid w-[70%] h-20">
                <label className="font-bold mr-2">NOME DA MÃE</label>
                <input className="border rounded-md w-auto" type="text" value={nomeMae} onChange={(e) => setNomeMae(e.target.value)}/>
            </div>
            <div className="grid w-[70%] h-20">
                <label className="font-bold mr-2">ALTURA</label>
                <input className="border rounded-md w-auto" type="text" value={altura} onChange={(e) => setAltura(e.target.value)}/>
            </div>
            <div className="grid w-[70%] h-20">
                <label className="font-bold mr-2">PESO</label>
                <input className="border rounded-md w-auto" type="text" value={peso} onChange={(e) => setPeso(e.target.value)}/>
            </div>
            <div className="grid w-[70%] h-20">
            ...
            <div className="grid w-[70%] h-20">
                ...
                <input className="border rounded-md w-auto" type="text" value={numero} onChange={(e) => setNumero(e.target.value)}/>
            </div>
            <div className="grid w-[70%] h-20">
            ...
            <div className="grid w-[70%] h-20">
                ...
                <textarea className="border rounded-md w-auto" placeholder="Opcional" value={infoPessoais} onChange={(e) => setInfoPessoais(e.target.value)}/>
            </div>
        </form>
        </div>
    )
